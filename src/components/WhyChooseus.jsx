...
const WhyChooseUs = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Social Impact",
      description:
        "3% of every project’s revenue is allocated to children’s education and healthcare in Nepal’s Terai, Hilly, and Himalayan regions.",
    },
    {
    ...
    <section className="bg-gray-50 py-16 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
          Why Choose <span className="text-purple-700">MapTech Agency?</span>
        </h2>
